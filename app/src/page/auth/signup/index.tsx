...
import { Response } from "context/user-context";
...
export const Signup: React.FC = () => {
  ...
  const onSubmit = handleSubmit(async (form: any) => {
    auth.signup({ ...form }, (response: Response) => {
      if (response.ok) {
        ...
        <div className=" w-full ">
          <div>
            <img
              ...
              alt="Workflow"
            />
            <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">S'inscrire</h2>
          </div>
