...
exports.fetchByExpression = async ({ expression, proximity = "", language = "fr", limit = "5", bbox = "", autocomplete = true }) => {
  const options = { proximity, language, limit, bbox, autocomplete, country: ["FR", "UA", "PL"] };
